...
<Why this shape exists, what boundary it creates, and what outcome it should make possible.>
...
- <handoff, return note, thread, worktree, commit, screenshot, or run doc>
